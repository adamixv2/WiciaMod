...
@app_commands.describe(uzytkownik="Kogo", powod="Powód (dokładnie to poleci na PV)")
@is_mod()
...
@app_commands.describe(uzytkownik="Kogo", czas="np. 10m, 1h, 2h 30m, 1d", powod="Powód (dokładnie to poleci na PV)")
@is_mod()
