...
@is_mod()
async def ban(interaction: discord.Interaction, uzytkownik: discord.Member, powod: str = "Brak powodu", czas: str = None):
    ...
    await uzytkownik.ban(reason=f"{interaction.user} | {powod}" + (f" | {czas}" if czas else ""), delete_message_days=1)
